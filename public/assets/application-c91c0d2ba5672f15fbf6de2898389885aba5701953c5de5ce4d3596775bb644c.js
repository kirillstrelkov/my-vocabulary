...
(function() {
  var glyphicon_ok_html;

  glyphicon_ok_html = "<span class='glyphicon glyphicon-ok' aria-hidden='true'>";

  $(document).ready(function() {
    var add_alert, load_languages_and_select_one, select_row, update_session;
    $('.selectpicker').selectpicker();
    $('#try_it').click(function() {
      var guest_email;
      guest_email = 'guest@localhost';
      $('#user_email').val(guest_email);
      return $('#user_password').val(guest_email);
    });
    $('#change_langs').click(function() {
    ...
    $('#lang_code1').change(function() {
      var lang, lang_code;
      lang_code = $(this).val();
      lang = $('body').prop('lang');
      return load_languages_and_select_one(lang_code, lang, null);
    });
    $('#lang_code2').change(function() {
      return update_session();
    });
    ...
    $('#translate').click(function() {
      ...
      return $.getJSON('/dictionary/yandex/lookup', {
        ...
        if (resp.code) {
          ...
          $('.alerts').empty();
          return add_alert('warning', 'No translations were found');
        } else {
          $(resp).each(function(i, e) {
            ...
            text = e['text'];
            tr = e['tr'];
            return $('table tbody').append("<tr class='translation cursor-pointer'><td class='status'>" + glyphicon_ok_html + "</td><td class='lang_pair'>" + lang_pair + "</td><td class='pos'>" + pos + "</td><td class='text1'>" + text + "</td><td class='text2'>" + tr + "</td></tr>");
          });
    ...
    $('#add-words').click(function() {
      $('.alerts').empty();
      return $('td.status > span.glyphicon').each(function() {
        var data, lang_code1, lang_code2, lang_pair, pos, row, text1, text2;
    ...
    return load_languages_and_select_one = function(lang_code, lang, selected_lang) {
