...
(function() {
  ...
  $(document).ready(function() {
    var add_alert, b_hide, b_show, load_languages_and_select_one, select_row, show_correct_card_and_disable_cards, update_session;
      ...
      return $.getJSON('/dictionary/yandex/lookup', {
        ...
        if (resp.code) {
          ...
          $(resp).each(function(i, e) {
            ...
            pos = e['pos'];
            gender = e['gen'] != null ? e['gen'] : '';
            text = e['text'];
            tr = e['tr'];
            return $('table tbody').append("<tr class='translation cursor-pointer'><td class='status'></td><td class='lang_pair'>" + lang_pair + "</td><td class='pos'>" + pos + "</td><td class='gender'>" + gender + "</td><td class='text1'>" + text + "</td><td class='text2'>" + tr + "</td></tr>");
          });
