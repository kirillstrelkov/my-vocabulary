...
(function() {
  ...
  $(document).ready(function() {
    var add_alert, b_hide, b_show, load_languages_and_select_one, select_row, show_correct_card, update_session;
      ...
      return $.getJSON('/dictionary/yandex/lookup', {
        ...
        if (resp.code) {
          ...
          $(resp).each(function(i, e) {
            ...
            text = e['text'];
            tr = e['tr'];
            return $('table tbody').append("<tr class='translation cursor-pointer'><td class='status'></td><td class='lang_pair'>" + lang_pair + "</td><td class='pos'>" + pos + "</td><td class='text1'>" + text + "</td><td class='text2'>" + tr + "</td></tr>");
          });
    ...
    show_correct_card = function() {
      var word_id;
      word_id = $('#cards .word').attr('data-word-id');
      return $("#cards .card[data-word-id='" + word_id + "']").addClass('btn-success');
    };
    b_show = function(e) {
