  ...
  $(document).ready(function() {
    ...
    $('#lang_code1').change(function() {
      ...
      return $.getJSON('/dictionary/yandex/pairs', {
        ...
        lang_select2.empty();
        return $(resp).each(function(index, arg) {
          var text, value;
    ...
    $('#cards .card').click(function() {
      ...
      return $("#cards .card[data-word-id!=" + trans_id + "]").each(function() {
    ...
    $('#add-words').click(function() {
      return $('td.status > span.glyphicon').each(function() {
        ...
        return $.post('/words.json', data, function(resp) {
          ...
          return add_alert('success', message);
        }).error(function(resp) {
    ...
    return select_row = function(row, selected) {
      var glyph, status;
      row = $(row);
      glyph = 'span.glyphicon';
