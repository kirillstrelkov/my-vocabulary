  ...
  describe 'POST #create' do
    ...
    context 'with invalid params' do
      it 'assigns a newly created but unsaved word as @word' do
        post :create, { word: invalid_attributes }, valid_session
        expect(assigns(:word)).to be_a_new(Word)
      end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested word' do
        word = Word.create! valid_attributes
        put :update, { id: word.to_param, word: new_attributes }, valid_session
        word.reload
    ...
    context 'with invalid params' do
      it 'assigns the word as @word' do
        word = Word.create! valid_attributes
        put :update, { id: word.to_param, word: invalid_attributes }, valid_session
        expect(assigns(:word)).to eq(word)
      end
